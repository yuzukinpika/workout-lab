...
export const BUILTIN=[
  ...
  ['ディップス','胸','bodyweight',0],['スミスマシンベンチプレス','胸','machine',0],
  ...
  ['ケーブルプルオーバー','背中','cable',0],['ダイバージングローロウ','背中','machine',0],
  ['Tバーロウ','背中','barbell',0],['シュラッグ','背中','barbell',0],['ハイパーエクステンション','背中','bodyweight',0],
  ...
  ['アップライトロウ','肩','barbell',0],['リアデルトフライ','肩','machine',0],
  ...
  ['プリーチャーカール','腕','barbell',0],['インクラインダンベルカール','腕','dumbbell',0],['キックバック','腕','dumbbell',1],
  ...
  ['フロントスクワット','脚','barbell',0],['ハックスクワット','脚','machine',0],['ランジ','脚','dumbbell',0],
  ['アダクション','脚','machine',0],['アブダクション','脚','machine',0],
